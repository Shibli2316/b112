        ...
        <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md lg:col-span-3">
            ...
            <div>
                ...
                <form action="editProfile.php?id=<?=$userEmail?>" method="post">
                    ...
                    <div class="mb-6">
                        <label for="current_org" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Organisation</label>
                        <input type="text" id="current_org" name="current_org" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="abc@def.com" value="<?=$rowUserData['current_org']?>" readonly />
                    </div>
                    <div class="mb-6">
                        <label for="org_address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address of organisation</label>
                        <input type="text" id="org_address" name="org_address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="123456789" required />
                    </div>
                    <div class="mb-6">
