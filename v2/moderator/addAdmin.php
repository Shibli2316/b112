...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($numExistRows > 0) {
        ...
        $sql2 = "INSERT INTO `admin` (`name`, `email`, `current_org`) VALUES ('$name', '$email', '$org')";
    ...
    <?php
        if($insert){
            ...
            <div class='flex items-center p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800' role='alert'>
                ...
                <div>
                    <span class='font-medium'>Success alert!</span> Admin has been added. -->
                </div>
        ...
        <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md lg:col-span-3">
            ...
            <div>
                ...
                <form action="addAdmin.php" method="post">
                    ...
                    <div class="mb-6">
                        <label for="org" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Organisation</label>
                        <input type="text" id="org" name="org" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="123ABC" required />
                    </div>
                    
                    <div class="mb-6">
                        <label for="created_password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Create Password</label>
