...
<body class="bg-gray-50 text-gray-800">
    ...
    <main class="flex-grow">
        <section class="text-white py-16" style="background-color: #A8D5BA;">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="bg-gray-50 p-8 rounded-lg shadow-md">
                    ...
                    <form action="submit_contact.php" method="POST" class="space-y-6">
                        ...
                        <div>
                            <button type="submit" 
                                    class="w-full bg-green-600 text-white py-2 px-4 rounded-lg font-medium hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500">
                                Send Message
                            </button>
                        </div>
                    </form>
                ...
                <!-- Contact Information -->
                <div class="bg-gray-50 p-8 rounded-lg shadow-md">
                    <h2 class="text-2xl font-semibold mb-4 text-green-600">Contact Information</h2>
                    <p class="text-gray-600 mb-6">We are always open to discuss your ideas or answer your questions.</p>
                    <ul class="space-y-4">
                        <li class="flex items-center">
                        <i class="fa-solid fa-envelope"></i>
                            <span class="p-4">Email: <a href="mailto:contact@ardms.org" class="text-red-500 hover:underline">contact@ardms.org</a></span>
                        </li>
                        <li class="flex items-center">
